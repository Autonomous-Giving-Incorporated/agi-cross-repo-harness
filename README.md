...
1. Pin a released Specs version. **Started:** `refs/versions.json` records Specs v2.0.0 (`c089739`); product SHAs remain PS #52, IR #17, Specs #17, AGI #23, and harness #20. Later docs-only tips (PS #58 `3e5194c`, Specs #19 `385619c`) are observed, not product pins. `specsMain` is the Specs workflow-pin revision, not a Specs version bump. Not READY.
