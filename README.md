...
1. Pin a released Specs version. **Started:** `refs/versions.json` records Specs v2.0.0 (`c089739`); consumer SHAs refreshed 2026-08-22 after PLAN-03 (harness #18) and Specs #14/#15. `specsMain` is the Specs workflow-pin revision, not a Specs version bump. Not READY.
