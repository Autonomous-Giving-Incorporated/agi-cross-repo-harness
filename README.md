...
1. Pin a released Specs version. **Started:** `refs/versions.json` records Specs v2.0.0 (`c089739`); consumer SHAs refreshed 2026-08-22 after PS #52, IR #17, Specs #17, and harness #19. `specsMain` is the Specs workflow-pin revision, not a Specs version bump. Not READY.
