...
1. Pin a released Specs version. **Started:** `refs/versions.json` records Specs v2.0.0 (`c089739`); product SHAs remain PS #52, IR #17, Specs #17, AGI #23, and harness #20. Later tips (PS #60 `204de69` SoT, PS #59 `36091e2` am_credit_pot CODE_SHIPPED, PS #58 `3e5194c`, Specs #19 `385619c`) are observed, not product pins. `specsMain` is the Specs workflow-pin revision, not a Specs version bump. Not READY.
